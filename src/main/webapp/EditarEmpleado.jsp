        ...
        <div class="container mt-5">
            ...
            <form action="EmpleadoServlet?action=actualizar" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="cargo" name="cargo" class="form-control" value="<%= empleado.getCargo() != null ? empleado.getCargo() : ""%>" required>

                    <label for="salario">Salario:</label>
                    <input type="text" id="salario" name="salario" class="form-control" value="<%= empleado.getSalario() != null ? empleado.getSalario() : ""%>" required>
