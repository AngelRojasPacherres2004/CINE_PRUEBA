...
public class EmpleadoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            } else if ("reporteHTML".equals(action)) {
                generarReporteHTML(request, response);  // <- AÑADE ESTA LÍNEA GENERAR REPORTE
            }
    ...
    private void generarReporteHTML(HttpServletRequest request, HttpServletResponse response)
            throws SQLException, ServletException, IOException {
        List<Empleado> lista = empleadoDao.listar();
        request.setAttribute("listaEmpleados", lista);
        RequestDispatcher dispatcher = request.getRequestDispatcher("Views/Empleado/ReporteEmpleados.jsp");
